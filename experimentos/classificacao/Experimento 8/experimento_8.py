...
"""
Experimento 8 (CEXP8), utilizar a mobilenet para fazer a classificação. A ideia é que a mobilenet possa ser utilizada em smartphones.
...
descricao_experimento = 'experimento8'
import os

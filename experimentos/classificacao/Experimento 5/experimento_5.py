...
"""
Experimento 7 (CEXP5), utilizar a estratégia de aplicar fine tunning ao xception para o mesmo dataset do experimento 6, 
verificando se houve alguma melhora, ou piora. Nos experimentos iniciais esse treinamento não convergia.
...
descricao_experimento = 'experimento7'
import os
